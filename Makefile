...
libhexclock.so: override LIBS += $(LIBXFCE4PANEL_LIBS)
libhexclock.so: override CFLAGS += $(LIBXFCE4PANEL_CFLAGS)
libhexclock.so: override LDFLAGS += -Wl,--no-undefined -Wl,--as-needed
